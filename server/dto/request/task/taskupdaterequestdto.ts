...
export const TaskUpdateRequestDTOParser = z.object({
    ...
    finished: z.optional(z.nullable(z.coerce.date({required_error: "select a date and time",invalid_type_error: "that's not a date"}))),
...
export type TaskUpdateRequestDTO = z.infer<typeof TaskUpdateRequestDTOParser> & TaskWithCategoriesAbstractDTO;